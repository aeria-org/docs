...
The [aeria.nvim](https://github.com/aeria-org/aeria.nvim) plugin ships the Aeria Language Server and Tree Sitter-powered syntax highlighting. Example of how to install using a Lua configuration file and the [lazy.nvim](https://github.com/folke/lazy.nvim) manager:
...
The [vim-aeria](https://github.com/aeria-org/vim-aeria) plugin provides syntax highlighting for Aeria. Example of how to install using a Lua configuration file and the [vim-plug](https://github.com/junegunn/vim-plug) plugin manager:
